...
\usepackage{color}
\usepackage[top=0in,bottom=1in,left=1in,right=1in,includehead,head=1in,headsep=0.9602in,nofoot]{geometry}
\usepackage{array}
\usepackage{hhline}
\usepackage{hyperref}
\usepackage{float}
...
\textbf{Reverse Engineering \& Exploitation Trek-through\newline
by: Owen Flannagan, Ambrose Douglas, Nick Lang, Elan Rasabi}
\par}
...
%\sitgfx{width=0.4583in,height=0.4689in}{FINALWORKINGDOCFORMERLYPRECURSOR-img001.png}{fig:abc}{Test caption.}
...
\newline
\newline
2.0 Looking at the assembly of a binary}
...
\sitgfx[width=6.4583in,height=4.5728in]{FINALWORKINGDOCFORMERLYPRECURSOR-img017.png}{fig:unk}{TODO CAPTION}
 \textbf{\newline
...
% Unhandled or unsupported graphics:
\sitgfx[width=6.5in,height=3.8055in]{FINALWORKINGDOCFORMERLYPRECURSOR-img018.png}{fig:unk}{TODO CAPTION}
